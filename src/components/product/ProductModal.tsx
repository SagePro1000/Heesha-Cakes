...
export function ProductModal({ product, isOpen, onClose, onOpenCart }: ProductModalProps) {
  ...
  useEffect(() => {
    if (product) {
      setFlavor(product.availableFlavors[0] || "");
            ...
            <div className="w-full md:w-1/2 flex flex-col h-full max-h-[90vh] overflow-y-auto relative">
              ...
              <div className="p-8 flex flex-col flex-1">
                <div className="mb-6">
                  ...
                  <p className="text-[#00B4D8] font-black text-2xl mt-4">{formatPrice(product.basePrice)}</p>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  ...
                  >
                    Add to Order • {formatPrice(product.basePrice)}
                  </button>
                </div>
              </div>
            </div>
